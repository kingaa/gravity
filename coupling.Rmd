...
```{r residual-plot,fig.height=6.83,purl=FALSE}
require(ncf)
...
```{r expectations from spatial models,purl=FALSE}
...
```{r k-means dendrogram of model predictions}
