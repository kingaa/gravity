...
```{r sv_g_imp_exp,include=FALSE,purl=FALSE}
stew(
  file="sv_g_imp_exp.rda",
  dependson=list(ied),
  {
    ied %>%
...
```{r sv_g_lisa,include=FALSE,purl=FALSE}
bake(
  file="sv_g_lisa.rds",
  dependson=list(comps,spatialLiks),
  {
...
```{r cd_g_lisa,include=FALSE,purl=FALSE}
bake(
  file="cd_g_lisa.rds",
  dependson=list(comps,spatialLiks),
  {
...
```{r fig3,include=FALSE,purl=FALSE,fig.height=10,fig.width=10}
library(cowplot)
